...
#define DUAL_X_CARRIAGE
  ...
  #define X1_MAX_POS X_BED_SIZE - 50   // A max coordinate so the X1 carriage can't hit the parked X2 carriage
  ...
  #define DEFAULT_DUPLICATION_X_OFFSET (X_BED_SIZE / 2) - 50
